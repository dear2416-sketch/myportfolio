// =============================================
// 사용법:
// 1. HTML에 <div id="gradient-container"></div> 추가
// 2. CSS에 아래 추가:
//    #gradient-container { width: 100%; height: 100%; position: relative; overflow: hidden; }
//    #gradient-container canvas { display: block; width: 100% !important; height: 100% !important; }
// 3. <script src="three.min.js"></script> 또는 CDN 추가 후 이 파일 로드
// =============================================
    ...
    this.uniforms = {
      ...
      uResolution: {
        value: new THREE.Vector2(
          sceneManager.container.clientWidth,
          sceneManager.container.clientHeight
        ),
      },
...
class App {
  constructor(containerId = 'gradient-container') {
    // ✅ container 요소 참조
    this.container = document.getElementById(containerId);
    if (!this.container) {
      console.error(`[GradientBG] #${containerId} 요소를 찾을 수 없습니다.`);
      return;
    }
...
// 앱 시작
// =============================================
const gradientApp = new App('gradient-container');
